...
L'adoption de WebGPU est une décision fondée sur les données, voir [ADR-0006](https://github.com/dopejs/pingo/blob/main/docs/adr/0006-webgpu-backend-decision.md).
...
Les algorithmes complets, les structures de données et les critères d'acceptation sont détaillés dans le [document de conception technique](https://github.com/dopejs/pingo/blob/main/docs/design.md).
