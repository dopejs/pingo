...
是否采用 WebGPU 是数据决策，见 [ADR-0006](https://github.com/dopejs/pingo/blob/main/docs/adr/0006-webgpu-backend-decision.md)。
...
- **样式** —— Shell 侧解析的版本化 CSS subset（支持表见[这里](/guide/style-support)），以及构建期的
...
完整的算法、数据结构与验收口径见[技术设计文档](https://github.com/dopejs/pingo/blob/main/docs/design.md)。
