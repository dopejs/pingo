...
(`@dopejs/pingo-host` и прочие) не обещают стабильности, а [сканер миграции](/guide/migration) не даёт
...
сборки. См. [диагностику](/guide/diagnostics).

## Граница миграции

`@dopejs/pingo-compat` — отдельный граничный пакет, предоставляющий `mountCompatPage` для постраничного
раскатывания и возврата. Подробности в [руководстве по миграции](/guide/migration).
