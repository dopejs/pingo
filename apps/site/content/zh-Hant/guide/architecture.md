...
是否採用 WebGPU 是資料決策，見 [ADR-0006](https://github.com/dopejs/pingo/blob/main/docs/adr/0006-webgpu-backend-decision.md)。
...
完整的演算法、資料結構與驗收口徑見[技術設計文件](https://github.com/dopejs/pingo/blob/main/docs/design.md)。
