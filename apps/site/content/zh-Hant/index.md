...
TSX 需要在 `tsconfig.json` 裡把 `jsxImportSource` 指向 `@dopejs/pingo`，見[快速開始](/guide/getting-started)。
...
bidi 視覺導航與 WebGPU 後端預設啟用仍是[已記錄的延後項](https://github.com/dopejs/pingo/blob/main/docs/plan.md)。
