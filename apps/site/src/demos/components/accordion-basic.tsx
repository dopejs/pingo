      ...
      >
        <Accordion defaultOpenValue="intro">
          <AccordionItem value="intro" title="什么是 pingo-ui？">
            <text value="与 shadcn/ui 对齐的组件库，渲染在 pingo canvas 引擎之上。" />
          </AccordionItem>
          <AccordionItem value="theme" title="支持暗色主题吗？">
            <text value="支持。所有组件跟随站点主题自动切换明暗两套皮肤。" />
          </AccordionItem>
          <AccordionItem value="keyboard" title="键盘可以操作吗？">
            <text value="方向键在标题之间移动焦点，Enter 或空格展开与收起。" />
          </AccordionItem>
        </Accordion>
      </container>,
    ]),
