...
La adopción o no de WebGPU es una decisión basada en datos; véase [ADR-0006](/adr/0006-webgpu-backend-decision).
...
Los algoritmos completos, las estructuras de datos y los criterios de aceptación se encuentran en el [documento de diseño técnico](/design).
