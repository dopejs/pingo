...
Tous les jalons d’ingénierie P0–M8 sont terminés ; M9 « qualification de production, composition incrémentale et durcissement de la publication » est planifié mais pas encore implémenté, voir [Plan M9](/m9-production-plan). Les changements actuels du dépôt restent dans Unreleased et n’indiquent pas qu’une nouvelle version npm a été publiée.
