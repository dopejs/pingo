...
כל אבני הדרך ההנדסיות P0–M8 הושלמו; M9 "כשירות לייצור, קומפוזיציה אינקרמנטלית והקשחת שחרור" כבר תוכנן, אך טרם החל
המימוש — ראו [תוכנית M9](/m9-production-plan). השינויים במאגר הנוכחי עדיין ב-Unreleased ואינם מעידים על פרסום
גרסת npm חדשה.
...
ניווט ויזואלי דו-כיווני והפעלת הקצה האחורי WebGPU כברירת מחדל הם עדיין [פריטים מתועדים שנדחו](/plan).
