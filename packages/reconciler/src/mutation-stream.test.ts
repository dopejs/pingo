...
describe("Mutation Stream", () => {
  ...
  it("round-trips a canonical transaction", () => {
    ...
    expect(toHex(bytes)).toBe(
      "444f504d180010007800000006000000010005000700000003000000ffffffffffffffff1000040007000000010000000040a0433000060009000000010000000500000068656c6c6f0000002000040007000000090000000a0000002100050007000000090000000a0000000b000000f00002002a000000",
    );
  });
