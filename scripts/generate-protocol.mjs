...
function validateSchema(value) {
  if (value.schemaVersion !== 1 || value.abiVersion !== 26) {
  ...
  validateNamedFields(value.documentBlockPayload.blockFields, "document block payload");
  if (value.documentBlockPayload.blockFields.some((field) => field.type !== "u32")) {
    throw new Error("document block records must be a packed u32 array");
  }
